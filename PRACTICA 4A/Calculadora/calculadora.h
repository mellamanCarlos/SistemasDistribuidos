...
#define SUMA 1
extern  float * suma_1(dupla_int *, CLIENT *);
extern  float * suma_1_svc(dupla_int *, struct svc_req *);
#define RESTA 2
extern  float * resta_1(dupla_int *, CLIENT *);
extern  float * resta_1_svc(dupla_int *, struct svc_req *);
#define MULTIPLICACION 3
extern  float * multiplicacion_1(dupla_int *, CLIENT *);
extern  float * multiplicacion_1_svc(dupla_int *, struct svc_req *);
#define DIVISION 4
extern  float * division_1(dupla_int *, CLIENT *);
extern  float * division_1_svc(dupla_int *, struct svc_req *);
